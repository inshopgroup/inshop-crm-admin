...
export default {
  ...
  computed: {
    ...
    showRoute() {
      return `${this.entity.toLowerCase()}-id-show___en`
    },
    updateRoute() {
      return `${this.entity.toLowerCase()}-id-update___en`
    },
  },
  created() {
        ...
        requestFunction: (params) =>
          new Promise((resolve) => {
            ...
            if (typeof params.orderBy !== 'undefined') {
              ...
              if (Object.keys(this.dateColumns).includes(params.orderBy)) {
                key = this.dateColumns[params.orderBy]
              } else if (
                Object.keys(this.customColumns).includes(params.orderBy)
              ) {
            ...
            this.$axios
              .get(`${process.env.NUXT_ENV_API_URL}/${this.route}`, {
                params: queryParams,
              })
              .then((response) => {
                const data = {
