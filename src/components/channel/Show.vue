<template>
  <div>
    ...
    <section class="content">
      <item-show-errors :entity="'channel'" :is-loading="isLoading"></item-show-errors>
      ...
      <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="history">
            <history :item="item" :entity="'Channel'" :path="'channel'"></history>
          </div>
        </div>
      </div>
...
export default {
  ...
  computed: mapGetters({
    isLoading: 'channel/show/isLoading',
    item: 'channel/show/retrieved'
  }),
  ...
  methods: {
    ...mapActions({
      reset: 'channel/show/reset',
      retrieve: 'channel/show/retrieve'
    })
  }
}
</script>
