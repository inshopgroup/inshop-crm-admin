<template>
  <div>
    ...
    <section class="content">
      <item-show-errors :entity="'project'" :is-loading="isLoading"></item-show-errors>
...
export default {
  components: {History, ProjectTasksTable, ClientDocuments, ProjectInfo, ItemShowErrors, ItemShowActions},
  computed: {
    ...mapGetters({
