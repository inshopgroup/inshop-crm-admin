<template>
  <div>
    ...
    <section class="content">
      <item-show-errors :entity="'city'" :is-loading="isLoading"></item-show-errors>
...
export default {
  ...
  computed: mapGetters({
    isLoading: 'city/show/isLoading',
    item: 'city/show/retrieved'
  }),
  ...
  methods: {
    ...mapActions({
      reset: 'city/show/reset',
      retrieve: 'city/show/retrieve'
    })
  }
}
</script>
