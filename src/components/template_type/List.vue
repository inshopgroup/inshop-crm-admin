...
<div>
  <section class="content-header">
    <h1>{{$t('template_type.list')}}</h1>
  </section>

  <section class="content">
    <div class="box box-primary">
      <div class="box-header with-border">
        <router-link :to="{ name: 'TemplateTypeCreate' }" class="btn btn-primary pull-right">{{$t('template_type.add')}}</router-link>
      </div>
      <div class="box-body">
        <item-list-errors :entity="'template_type'"></item-list-errors>
