...
<div>
  <section class="content-header">
    <h1>{{$t('country.list')}}</h1>
  </section>

  <section class="content">
    <div class="box box-primary">
      <div class="box-header with-border">
        <router-link :to="{ name: 'CountryCreate' }" class="btn btn-primary pull-right">{{$t('country.add')}}</router-link>
      </div>
      <div class="box-body">
        <item-list-errors :entity="'country'"></item-list-errors>
