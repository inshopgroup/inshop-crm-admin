    ...
    <section class="content">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <form-select :item="item" :errors="errors" :property="'clients'" :option-store="'client'" :label="$t('clients')" :multiple="true" @formUpdated="updateValue"></form-select>
          <form-select :item="item" :errors="errors" :property="'companies'" :option-store="'company'" :label="$t('companies')" :multiple="true" @formUpdated="updateValue"></form-select>
        </div>
      </div>
