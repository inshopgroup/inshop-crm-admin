    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <form-input :item="item" :errors="errors" :property="'username'" :label="$t('email')" @formUpdated="updateValue"></form-input>
<!--          <form-password :item="item" :errors="errors" :property="'plainPassword'" :label="$t('password')" @formUpdated="updateValue"></form-password>-->
          <form-select :item="item" :errors="errors" :property="'groups'" :option-store="'group'" :label="$t('groups_name')" :multiple="true" @formUpdated="updateValue"></form-select>
