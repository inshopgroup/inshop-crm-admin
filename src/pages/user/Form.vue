...
<script>
  ...
  import FormPassword from "../../components/layout/form/FormPassword";
  ...
  export default {
    components: {ItemErrors, FormCheckbox, FormSelect, FormPassword, FormInput, VuePassword, ItemEditActions},
    props: {
      handleSubmit: {
        type: Function,
        required: true
