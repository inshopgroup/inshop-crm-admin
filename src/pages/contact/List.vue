  ...
  <section class="content">
    <div class="box box-primary">
      <div class="box-header with-border">
        <router-link :to="{ name: 'ContactCreate' }" class="btn btn-primary pull-right">{{$t('contact_add')}}</router-link>
      </div>
      <div class="box-body">
...
export default {
  ...
  data: function () {
    return {
      ...
      filterable: ['id', 'value', 'contactType.name', 'columnCreatedAt', 'columnUpdatedAt'],
      sortable: ['id', 'value', 'contactType.name', 'columnCreatedAt', 'columnUpdatedAt'],
      templates: {
        columnCreatedAt,
        columnUpdatedAt
      }
