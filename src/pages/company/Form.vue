    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <form-number :item="item" :errors="errors" :property="'code'" :label="'company.code'" @formUpdated="updateValue"></form-number>
          ...
          <form-textarea :item="item" :errors="errors" :property="'comment'" :label="'company.comment'" @formUpdated="updateValue"></form-textarea>
          ...
          <form-select :item="item" :errors="errors" :property="'clients'" :option-store="'client'" :label="'company.clients'" :multiple="true" @formUpdated="updateValue"></form-select>
